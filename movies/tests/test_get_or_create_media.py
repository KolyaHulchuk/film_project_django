...
def db():
    return Movies.objects.create(
        title="Berserk", release_date=datetime.date(1997, 1, 1), country="American", tmdb_id=12
    )
...
def tmdb(mocker):
    ...
    fake_client.get_movie_by_tmdb_id.return_value = {
        "id": 550,
    ...
    fake_client.get_tv_by_tmdb_id.return_value = {
        "id": 1396,
        "origin_country": ["US"],
        "original_language": "en",

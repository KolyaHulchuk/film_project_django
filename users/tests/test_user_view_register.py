...
def test_register(client, mocker):
    ...
    response = client.post(
        "/users/register/",
        {"username": "Kolya", "email": "blabla@gmail.com", "password1": "Password_123", "password2": "Password_123"},
    )
...
def test_register_invalid(client):
    ...
    response = client.post(
        "/users/register/",
        {"username": "Kolya", "email": "dub@gamil.com", "password1": "Kolya6", "password2": "Kolya6"},
    )
